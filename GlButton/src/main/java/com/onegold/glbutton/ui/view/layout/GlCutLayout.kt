...
class GlCutLayout : GlLayout {
    ...
    override fun initAttrValue(attrs: AttributeSet?, defStyle: Int) {
        ...
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.GlCutLayout, defStyle, 0
        )

        // corner
        _leftTopCorner =
            a.getDimension(R.styleable.GlCutLayout_gl_leftTopCorner, _leftBottomCorner)
        _leftBottomCorner =
            a.getDimension(R.styleable.GlCutLayout_gl_leftBottomCorner, _leftBottomCorner)
        _rightTopCorner =
            a.getDimension(R.styleable.GlCutLayout_gl_rightTopCorner, _rightTopCorner)
        _rightBottomCorner =
            a.getDimension(R.styleable.GlCutLayout_gl_rightBottomCorner, _rightBottomCorner)
