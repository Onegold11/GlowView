...
abstract class GlLayout : ConstraintLayout {
    /** Solid color */
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        val a = context.obtainStyledAttributes(
            attrs, R.styleable.GlLayout, defStyle, 0
        )


        // Solid color
        _solidColor = a.getColor(R.styleable.GlLayout_gl_backgroundColor, _solidColor)
        _gradientColor = a.getColor(R.styleable.GlLayout_gl_gradientColor, _gradientColor)

        // Stroke color
        _strokeColor = a.getColor(R.styleable.GlLayout_gl_strokeColor, _strokeColor)
        _glowColor = a.getColor(R.styleable.GlLayout_gl_glowColor, _glowColor)

        // size
        _strokeWidth = a.getDimension(R.styleable.GlLayout_gl_strokeWidth, _strokeWidth)
        _glowWidth = a.getDimension(R.styleable.GlLayout_gl_glowWidth, _glowWidth)
